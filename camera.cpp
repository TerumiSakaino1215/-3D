...
{
	g_posCameraP = D3DXVECTOR3(0.0f, 200.0f, 0.0f);
	g_posCameraR = D3DXVECTOR3(0.0f, 50.0f, 0.0f);
	...
	//g_posCameraR = GetPositionPlayer();
...
void UpdateCamera(void)
{
	...
	g_posCameraP.z = posPlayer.z - 200.0f;
	g_posCameraR.z = posPlayer.z + 100;
	//g_posCameraR.y = posPlayer.y + 100;
